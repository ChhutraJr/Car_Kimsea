                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="cus" name="customer" class="custom-select select2 tags input1" >
                                                    ...
                                                    @foreach($cus as $c)
                                                        ...
                                                        ?>
                                                        @if(!empty(config('global.cus_id')))
                                                            @if(config('global.cus_id')==$c->id)
                                                                <option selected value="{{$c->id}}">{{$c->name}} {{$plate_no}}</option>
                                                            @else
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                <label>SA</label>
                                                <select name="sa[]" class="custom-select select2 tags input3 select-none" multiple>

                                                    @if(!empty(Liseng::$sa))
                                                        @foreach($sa as $s)
                                                            @php($n=0)
                                                            {{--Check all master multi sa to see if have in list sa or not--}}
                                                            @foreach(Liseng::$sa as $multi_sa)
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select name="mechanic[]" class="custom-select select2 tags input4 select-none" multiple>

                                                    @if(!empty(Liseng::$mechanic))
                                                        @foreach($mechanic as $m)
                                                            @php($n=0)
                                                            {{--Check all master multi mechanic to see if have in list mechanic or not--}}
                                                            @foreach(Liseng::$mechanic as $multi_mechanic)
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group ">
                                                ...
                                                <label>KM</label>
                                                <input name="km" type="text" class="form-control input5" placeholder="KM" >
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ro" class="form-control input6" placeholder="RO">
                                                <span class="text-danger">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control input-address hideSearch input7"
                                                          placeholder="Invoice Note" rows="1" name="note" ></textarea>
                                                <span class="text-danger">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="dis-amount-input" type="text" name="amount" class="form-control input8" placeholder="0.00">
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><b><span id="dis-amount">$0.00</span></b></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                        ...
                        <div class="col-md-12">
                            <div class="card no-b">
                                ...
                                <div style="text-align: right">
                                    <button type="button" onclick="$('#save-type').val('save_add_new')" class="btn btn-success btn-lg btn-add-invoice" style="margin: 0px 13px 15px 0px;" id="btn-save-add-new" ><i class="icon-save mr-2"></i>Save and Add new</button>
                                    <button type="button" onclick="$('#save-type').val('save')" class="btn btn-primary btn-lg" style="margin: 0px 13px 15px 0px;" id="btn-save" ><i class="icon-save mr-2"></i>Save</button>
                                </div>
                            </div>
                        </div>
...
//                                console.log(data);
            ...
            $('.no-active3-2').removeClass('no-active3-2').addClass('active');
        ...
        $('#btn-save-add-new').click(function (e) {
            e.preventDefault();
            save_data();
        });
...
//                            alert(total);
                            ...
                            $.ajax({
                                async: false,
                                type: 'post',
                                url: "{{route('store_detail.invoice')}}",
                                data: {
                                    "_token":"<?=csrf_token()?>",
                                    'qty': qty,
                                ...
                                success: function(data) {
                                    ...
                                    if (data.last=='true'){
                                        ...
                                        if (amount!=''&&amount!=null){
                                            ...
                                            $.ajax({
                                                async: false,
                                                url: "{{route('store_payment.invoice')}}",
                                                method: "POST",
                                                dataType: 'json',
                                                data: form,
                                                processData: false,
...
//                                                    console.log(data);
                                                    ...
                                                    if (data.verify=='true'){
                                                        ...
                                                        if ($('#save-type').val()=='save'){
                                                            ...
                                                            window.location.href='{{url(config('global.add_new_link'))}}/'+$('#cus').val();
                                                        }
                                                    }
                                            ...
                                            /*swal({
                                             title: "Success!",
                                             text: 'Add new with this customer ?',
                                             type: "success",
                                             showCancelButton: true,
                                             confirmButtonClass: "btn-success",
...
//                                console.log(data);
        ...
        function payment() {
            var total_payable=$('#total-payable').html();
            $('#amount').val(parseFloat(total_payable.replace("$","")).format(2)*1);
        }
