        ...
        <table border="1" style="    margin-left: 3px;width: 99%; margin-bottom: 35px; border-collapse: collapse; border-bottom: 0; border-left: 0;border-right: 1px solid black" id="table_content">
            ...
            @foreach ($detail as $item)
                <tr class="fs-9 text-center all-border-bot">
                    ...
                    <td class="font-ubuntu">{{'$'.number_format($item->cost_price, 2)}}</td>
            ...
            <tr class="fs-9 text-center">
                <td class="noborder text-right font-btb" style="padding-right: 10px;" colspan="5"><b>សរុប<span class="font-ubuntu">/Total</span></b></td>
            ...
            @if(Liseng::getInvoiceBySellID($id)->dis_total_amount>0)
                <tr class="fs-9 text-center">
                    <td class="noborder text-right font-btb" style="padding-right: 10px;" colspan="5"><b> បញ្ចុះតំលៃ<span class="font-ubuntu">/Discount</span></b></td>
                ...
                <tr class="fs-9 text-center">
                    <td class="noborder text-right font-btb" style="padding-right: 10px;" colspan="5"><b> តំលៃសរុប<span class="font-ubuntu">/Total Amount</span></b></td>
            ...
            <tr class="fs-9 text-center" height="23px">
                <td class="noborder text-right" colspan="5"></td>
                <td class="border-bot border-left font-ubuntu fs-9">{{'$'.number_format(Liseng::getInvoiceBySellID($id)->total_paid, 2)}}</td>
            </tr>
            <tr class="fs-9 text-center">
                <td class="noborder text-right font-btb fs-9" colspan="5" style="padding-right: 10px;"><b>នៅសល់<span class="font-ubuntu">/Balance</span></b></td>
