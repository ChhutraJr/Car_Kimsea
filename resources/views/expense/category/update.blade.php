                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">Expense Category <span class="required">*</span></label>
                                                <input name="name"  id="category" placeholder="Enter Category Name" class="form-control-lg r-0 light s-12 input1" type="text" value="{{$master->name}}">
                                            </div>
...
@section('data')
    <script type="text/javascript">
        ...
        $("#category").on("input", function(e) {
            ...
            $.ajax({
                /* location to go*/
                url: "{{route('exp_cat.validate_name')}}",
                method: "POST",
                dataType: 'json',
                data: {
                    'name':name,
