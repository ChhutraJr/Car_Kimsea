                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">Vehicle Model <span class="required">*</span></label>
                                                    <input name="name"  id="model" placeholder="Enter Model Name" class="form-control-lg r-0 light s-12 input1" type="text">
                                            </div>
...
@section('data')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.no-active2-3').removeClass('no-active2-3').addClass('active');
        });
