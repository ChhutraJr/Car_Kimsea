                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group m-0">
                                                <label for="name" class="col-form-label s-12">Supplier <span class="required">*</span></label>
                                                    <input name="name"  placeholder="Enter Supplier Name" id="sup" class="form-control-lg r-0 light s-12 input1" type="text">
                                            </div>
...
@section('data')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.no-active4-4').removeClass('no-active4-4').addClass('active');
        });

        //  supplier _name_validate
        $("#sup").on("input", function(e) {
            clear_border(['input1']);     //Chart on load
            clear_error(['error1']);
            $.ajax({
                /* location to go*/
                url: "{{route('supplier.validate_name')}}",
                method: "POST",
                dataType: 'json',
                data: {
                    'name':$('#sup').val(),
