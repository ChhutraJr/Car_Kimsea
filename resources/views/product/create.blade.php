                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group ">
                                                ...
                                                <select name="product_name" class="font-btb custom-select select2 tags input1" id="pro" >
                                                    <option value="">Select None</option>

                                                    @foreach($pros as $p)
                                                        @if(!empty(config('global.pro_name')))
                                                            @if(config('global.pro_name')==$p->name)
                                                ...
                                                {{-- <input name="product_name" type="text" class="form-control input1" id="pro_name" placeholder="Product Name" >
 --}}
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input   type="text" name="code_part"  id ="code_part" class="form-control input3" placeholder="Code Part">
                                                <span class="text-danger">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div style="text-align: right">
                                    <button type="submit" onclick="$('#save-type').val('save_add_new')" class="btn btn-success btn-lg btn-add-sale" style="margin: 0px 13px 15px 0px;" id="btn-save-add-new" ><i class="icon-save mr-2"></i>Save and Add New</button>
                                    <button type="submit" onclick="$('#save-type').val('save_add_another')" class="btn btn-danger  btn-lg btn-add-another " style="margin: 0px 13px 15px 0px;" id="btn-save-add-another" ><i class="icon-save mr-2"></i>Save and Add Another</button>
...
@section('data')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.no-active4-2').removeClass('no-active4-2').addClass('active');
        });
   ...
   // On change Products
        ...
        $("#btn-save-add-another").click(function (e) {
            e.preventDefault();
            save_data();
        });
        function save_data() {
...
//                        $("#form-product")[0].reset();
                            ...
                            for(var i=1;i<rowCount+1;i++) {
                                ...
                                $.ajax({
                                    async: false,
                                    type: 'post',
                                    url: "{{route('store_detail.product')}}",
                                    data: {
                                        "_token":"<?=csrf_token()?>",
                                        'qty': qty,
...
//                                        console.log(data);
                                        ...
                                        if (data.last=='true'){
                                            if ($('#save-type').val()=='save'){
                                                ...
                                                window.location.href='{{url('product/create/')}}'+'/'+data.pro_name;
                                            }
                                        }
